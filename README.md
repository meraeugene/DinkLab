...
Next.js booking app for Dink Lab pickleball courts with Tailwind CSS, Supabase Google auth/database, manual payment review, and Gmail/Nodemailer booking acceptance emails.
...
5. On Vercel, add the same env vars.
